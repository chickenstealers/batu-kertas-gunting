...
function lose(userChoice, computerChoice){
    ...
    userScore_span.innerHTML = userScore;
    computerScore_span.innerHTML = computerScore;
    result_p.innerHTML = `${convertToWord(userChoice)} kalah dari ${convertToWord(computerChoice)}. Kamu kalah!`;
...
function draw(userChoice, computerChoice){
    userScore_span.innerHTML = userScore;
    computerScore_span.innerHTML = computerScore;
    result_p.innerHTML = `${convertToWord(userChoice)} = ${convertToWord(computerChoice)}. Hasilnya draw!`;
